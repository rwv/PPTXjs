...
export function getTableRowStyle(
    ...
    const applyStyleFromPath = (basePath: string[]) => {
        ...
        const bgFillschemeClr = getTextByPathList(thisTblStyle, [...basePath, "a:tcStyle", "a:fill", "a:solidFill"]);
    ...
    if (rowIndex === (totalRows - 1) && tblStylAttrObj["isLstRowAttr"] === 1 && thisTblStyle !== undefined) {
