 ...
 */
export function applyShade(rgbStr: string, shadeValue: number | string, isAlpha: boolean): string {
  const shade = typeof shadeValue === "number" ? shadeValue : parseFloat(shadeValue);
