/**
 * Arrow callout shape renderers.
 *
 * Handles: rightArrowCallout, downArrowCallout, leftArrowCallout, upArrowCallout,
...
/**
 * Render left-right arrow callout
 */
