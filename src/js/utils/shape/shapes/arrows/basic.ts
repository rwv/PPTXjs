/**
 * Basic arrow shape renderers.
 *
 * Handles: rightArrow, leftArrow, downArrow, upArrow, leftRightArrow, upDownArrow
 */

import { getTextByPathList } from "../../../object";
import type { ArrowShapeContext } from "./shared";
import { createPolygon } from "./shared";
...
/**
 * Render down arrow (also handles flowChartOffpageConnector)
 */
