/**
 * Complex arrow shape renderers.
 *
 * Handles: quadArrow, leftRightUpArrow, leftUpArrow, bentUpArrow,
 *          bentArrow, uturnArrow, stripedRightArrow, notchedRightArrow
 */
