/**
 * Circular arrow shape rendering functions.
 *
 ...
 */
function getFillAttr(ctx: CircularArrowContext): string {
 ...
 */
function getStrokeAttrs(ctx: CircularArrowContext): string {
  const { border } = ctx;
 ...
 */
function createPath(d: string, ctx: CircularArrowContext): string {
  return `<path d='${d}' fill='${getFillAttr(ctx)}' ${getStrokeAttrs(ctx)} />`;
}

// =============================================================================
// Circular Arrow Shape Renderers
// =============================================================================

/**
 * Render circularArrow shape
 */
function renderCircularArrow(ctx: CircularArrowContext): string {
 ...
 */
function renderLeftCircularArrow(ctx: CircularArrowContext): string {
  const { node, w, h, slideFactor } = ctx;
