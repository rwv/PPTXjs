...
export function isBasicShape(shapType: string): boolean {
    const basicShapes = [
        "rect", "flowChartProcess", "flowChartPredefinedProcess", "flowChartInternalStorage",
        "actionButtonBlank", "irregularSeal1", "irregularSeal2",
        "ellipse", "flowChartConnector", "flowChartSummingJunction", "flowChartOr",
        "roundRect", "round1Rect", "round2DiagRect", "round2SameRect",
        "snip1Rect", "snip2DiagRect", "snip2SameRect",
        "flowChartAlternateProcess", "flowChartPunchedCard", "snipRoundRect"
    ];
