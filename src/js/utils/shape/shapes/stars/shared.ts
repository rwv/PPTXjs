/**
 * Shared utilities for star shape rendering.
 */
 ...
 */
export function createStarPath(d: string, ctx: StarShapeContext): string {
 ...
 */
export function parseSingleAdj(node: PptxNode, defaultVal: number, slideFactor: number): number {
