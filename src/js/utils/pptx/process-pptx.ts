...
export function processPPTX(
    ...
    genGlobalCSS: any
            ...
            for (var i = 0; i < numOfSlides; i++) {
                ...
                var slideHtml = processSingleSlide(zip, filename, i, slideSize, defaultTextStyle, app_verssion, processFullTheme, tableStyles, isFirstBr, styleTable, rtlLangsArray, slideFactor, fontSizeFactor, chartID, MsgQueue, settings, processNodesInSlide, processSpNode, processCxnSpNode, processPicNode, processGraphicFrameNode, processGroupSpNode, genShape, genTable, genChart, genDiagram, getBackground);
                post_ary.push({
                    "type": "slide",
                    "data": slideHtml,
