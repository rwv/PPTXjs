    ...
    $.fn.pptxToHtml = function (options: any) {
        ...
        function processPPTX(zip: JsZip) {
            ...
            for (var i = 0; i < numOfSlides; i++) {
                ...
                var slideHtml = processSingleSlide(zip, filename, i, slideSize, defaultTextStyle, tableStyles, {value: is_first_br}, styleTable, rtl_langs_array, slideFactor, fontSizeFactor, chartID, MsgQueue, settings, processNodesInSlide, processSpNode, processCxnSpNode, processPicNode, processGraphicFrameNode, processGroupSpNode, genShape, genTable, genChart, genDiagram, getBackground);
                post_ary.push({
                    "type": "slide",
                    "data": slideHtml,
