...
import { getTableCellParams } from "./utils/table";
        ...
        function genShape(node: any, pNode: any, slideLayoutSpNode: any, slideMasterSpNode: any, id: any, name: any, idx: any, type: any, order: any, warpObj: any, isUserDrawnBg: any, sType: any, source: any) {
            ...
            if (shapType !== undefined && custShapType === undefined) {
                ...
                if (node["p:txBody"] !== undefined && (isUserDrawnBg === undefined || isUserDrawnBg === true)) {
                    ...
                    result += genTextBody(node["p:txBody"], node, slideLayoutSpNode, slideMasterSpNode, type, idx, warpObj, undefined, {value: is_first_br}, styleTable, rtl_langs_array, slideFactor, fontSizeFactor); //type='shape'
                }
                result += "</div>";
                ...
                // TextBody
                if (node["p:txBody"] !== undefined && (isUserDrawnBg === undefined || isUserDrawnBg === true)) {
                    result += genTextBody(node["p:txBody"], node, slideLayoutSpNode, slideMasterSpNode, type, idx, warpObj, undefined, {value: is_first_br}, styleTable, rtl_langs_array, slideFactor, fontSizeFactor);
                }
                result += "</div>";
                        ...
                        if (tcNodes.constructor === Array) {
                            ...
                            while (j < tcNodes.length) {
                                if (rowSpanAry[j] == 0 && totalColSpan == 0) {
                                    ...
                                    var cellParmAry = getTableCellParams(tcNodes[j], getColsGrid, i , j , thisTblStyle, a_sorce, warpObj, {value: is_first_br}, styleTable, rtl_langs_array, slideFactor, fontSizeFactor)
                            ...
                            var cellParmAry = getTableCellParams(tcNodes, getColsGrid , i , undefined , thisTblStyle, a_sorce, warpObj, {value: is_first_br}, styleTable, rtl_langs_array, slideFactor, fontSizeFactor)
                            var text = cellParmAry[0];
                            var colStyl = cellParmAry[1];
                            var cssName = cellParmAry[2];
                            var rowSpan = cellParmAry[3];
