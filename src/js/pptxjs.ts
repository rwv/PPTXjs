    ...
    $.fn.pptxToHtml = function (options: any) {
        ...
        */
        ...
        function getTableCellParams(tcNodes: any, getColsGrid: any , row_idx: any , col_idx: any , thisTblStyle: any, cellSource: any, warpObj: any) {
            ...
            var text = genTextBody(tcNodes["a:txBody"], tcNodes, undefined, undefined, undefined, undefined, warpObj, total_col_width, {value: is_first_br}, styleTable, rtl_langs_array, slideFactor, fontSizeFactor);//tableStyles
